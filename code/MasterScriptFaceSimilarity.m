...
histogram(mean_theta_above_identity_line, 'FaceColor',colour_above_identity_line, 'FaceAlpha', 0.5, 'EdgeAlpha', 1);
hold on;
histogram(mean_theta_below_identity_line, 'FaceColor',colour_below_identity_line, 'FaceAlpha', 0.5, 'EdgeAlpha', 1);
...
histogram(abs_difference_r1_r2_above_identity_line, 'FaceColor',colour_above_identity_line, 'FaceAlpha', 0.5, 'EdgeAlpha', 1);
hold on;
histogram(abs_difference_r1_r2_below_identity_line, 'FaceColor',colour_below_identity_line, 'FaceAlpha', 0.5, 'EdgeAlpha', 1);
...
%% WRONG plot histogram for MEAN mean r1  below and above identity line
close all;
figure;
...
histogram(mean_r1_above_identity_line, 'FaceColor',colour_above_identity_line, 'FaceAlpha', 0.5, 'EdgeAlpha', 1);
hold on;
histogram(mean_r1_below_identity_line, 'FaceColor',colour_below_identity_line, 'FaceAlpha', 0.5, 'EdgeAlpha', 1);
...
save_figure_kmj('analysis/histograms/hist_same_differnt_identity_r_2', figure(1));
...
histogram(mean_r2_above_identity_line,  'FaceColor',colour_above_identity_line, 'FaceAlpha', 0.5, 'EdgeAlpha', 1);
hold on;
histogram(mean_r2_below_identity_line,'FaceColor',colour_below_identity_line, 'FaceAlpha', 0.5, 'EdgeAlpha', 1);
...
save_figure_kmj('analysis/histograms/hist_same_differnt_identity_r2', figure(1));
...
save_figure_kmj('analysis/histograms/hist_same_differnt_identity_mean_r1_r2', figure(1));
...
histogram(mean_eu_dist_above_identity_line, 'FaceColor',colour_above_identity_line, 'FaceAlpha', 0.5, 'EdgeAlpha', 1);
hold on;
histogram(mean_eu_dist_below_identity_line, 'FaceColor',colour_below_identity_line, 'FaceAlpha', 0.5, 'EdgeAlpha', 1);
