...
%% WRONG plot histogram for MEAN theta below and above identity line
close all;
figure;
...
histogram(mean_theta_above_identity_line_iso, 'FaceColor',colour_above_identity_line, 'FaceAlpha', 0.5, 'EdgeAlpha', 1);
hold on;
histogram(mean_theta_below_identity_line_iso, 'FaceColor',colour_below_identity_line, 'FaceAlpha', 0.5, 'EdgeAlpha', 1);
...
ylabel('Frequency', 'FontName','Arial', 'Fontsize', 50);
% ylabel('Frequency of facial dissimilarity judgements', 'FontName','Arial', 'Fontsize', 40);
xlabel('BFM Theta', 'FontName','Arial', 'Fontsize', 50);
...
%% WRONG plot histogram for MEAN absolute difference between r1 and r2 below and above identity line
close all;
figure;
...
histogram(abs_difference_r1_r2_above_identity_line_iso, 'FaceColor',colour_above_identity_line, 'FaceAlpha', 0.5, 'EdgeAlpha', 1);
hold on;
histogram(abs_difference_r1_r2_below_identity_line_iso, 'FaceColor',colour_below_identity_line, 'FaceAlpha', 0.5, 'EdgeAlpha', 1);
...
ylabel('Frequency', 'FontName','Arial', 'Fontsize', 50);
% ylabel('Frequency of facial dissimilarity judgements', 'FontName','Arial', 'Fontsize', 40);
xlabel('BFM absolute difference between r_{1} and r_{2}', 'FontName','Arial', 'Fontsize', 50);

set(gcf, 'Units', 'Inches', 'Position', [0, 0, 20, 10], 'PaperUnits', 'Inches', 'PaperSize', [20, 10])

save_figure_kmj('analysis/histograms/hist_same_differnt_identity_abs_difference_r1_r2_iso', figure(1));

%% WRONGplot histogram for MEAN mean r1  below and above identity line
close all;
figure;
...
histogram(mean_r1_above_identity_line_iso, 'FaceColor',colour_above_identity_line, 'FaceAlpha', 0.5, 'EdgeAlpha', 1);
hold on;
histogram(mean_r1_below_identity_line_iso, 'FaceColor',colour_below_identity_line, 'FaceAlpha', 0.5, 'EdgeAlpha', 1);
...
ylabel('Frequency', 'FontName','Arial', 'Fontsize', 50);
% ylabel('Frequency of facial dissimilarity judgements', 'FontName','Arial', 'Fontsize', 40);
xlabel('BFM r_{2}', 'FontName','Arial', 'Fontsize', 50);

set(gcf, 'Units', 'Inches', 'Position', [0, 0, 20, 10], 'PaperUnits', 'Inches', 'PaperSize', [20, 10])

save_figure_kmj('analysis/histograms/hist_same_differnt_identity_r_2_iso', figure(1));

%% WRONG plot histogram for MEAN mean r2 below and above identity line
close all;
...
histogram(mean_r2_above_identity_line_iso,  'FaceColor',colour_above_identity_line, 'FaceAlpha', 0.5, 'EdgeAlpha', 1);
hold on;
histogram(mean_r2_below_identity_line_iso,'FaceColor',colour_below_identity_line, 'FaceAlpha', 0.5, 'EdgeAlpha', 1);
...
save_figure_kmj('analysis/histograms/hist_same_differnt_identity_r2_iso', figure(1));

% %% WRONG plot histogram for MEAN mean r1 and r2 below and above identity line
% close all;
% figure;
% 
% colour_above_identity_line_iso = [180/255,180/255,180/255];
% colour_below_identity_line_iso = [100/255,100/255,100/255];
% 
% histogram(mean_mean_r1_r2_above_identity_line, 'FaceColor',colour_above_identity_line,'FaceAlpha', 0.5, 'EdgeAlpha', 1);
% hold on;
% histogram(mean_mean_r1_r2_below_identity_line, 'FaceColor',colour_below_identity_line, 'FaceAlpha', 0.5, 'EdgeAlpha', 1);
% 
% l = legend( 'different identity', 'same identity');
% l.FontSize = 50;
% l.FontName = 'Arial';
...
% ylabel('Frequency', 'FontName','Arial', 'Fontsize', 50);
% % ylabel('Frequency of facial dissimilarity judgements', 'FontName','Arial', 'Fontsize', 40);
% xlabel('BFM mean r_{1} r_{2}', 'FontName','Arial', 'Fontsize', 50);
% 
% set(gcf, 'Units', 'Inches', 'Position', [0, 0, 20, 10], 'PaperUnits', 'Inches', 'PaperSize', [20, 10])
% 
% save_figure_kmj('analysis/histograms/hist_same_differnt_identity_mean_r1_r2_iso', figure(1));
% 
% %% WRONG plot histogram for MEAN eu dist below and above identity line
% close all;
% figure;
% 
% colour_above_identity_line = [180/255,180/255,180/255];
% colour_below_identity_line = [100/255,100/255,100/255];
% 
% histogram(mean_eu_dist_above_identity_line_iso, 'FaceColor',colour_above_identity_line, 'FaceAlpha', 0.5, 'EdgeAlpha', 1);
% hold on;
% histogram(mean_eu_dist_below_identity_line_iso, 'FaceColor',colour_below_identity_line, 'FaceAlpha', 0.5, 'EdgeAlpha', 1);
% 
% l = legend( 'different identity', 'same identity');
% l.FontSize = 50;
% l.FontName = 'Arial';
...
% ylabel('Frequency', 'FontName','Arial', 'Fontsize', 50);
% % ylabel('Frequency of facial dissimilarity judgements', 'FontName','Arial', 'Fontsize', 40);
% xlabel('BFM Euclidean distance', 'FontName','Arial', 'Fontsize', 50);
% 
% set(gcf, 'Units', 'Inches', 'Position', [0, 0, 20, 10], 'PaperUnits', 'Inches', 'PaperSize', [20, 10])
% 
% save_figure_kmj('analysis/histograms/hist_same_differnt_identity_eu_dist_iso', figure(1));
...
% 
% 
% %% WRONG ttest if distributions are statistically differnt from each other: above and below identity line theta, r1, r2, r1-r2
% significant_difference_eu_dist_below_above_identity_line_iso = ttest2(mean_eu_dist_below_identity_line_iso, mean_eu_dist_above_identity_line_iso);
% 
% significant_difference_theta_below_above_identity_line_iso = ttest2(mean_theta_below_identity_line_iso, mean_theta_above_identity_line_iso);
% 
% significant_difference_r1_below_above_identity_line_iso = ttest2(mean_r1_below_identity_line_iso, mean_r1_above_identity_line_iso);
% 
% significant_difference_r2_below_above_identity_line_iso = ttest2(mean_r2_below_identity_line_iso, mean_r2_above_identity_line_iso);
% 
% significant_difference_mean_r1_r2_below_above_identity_line_iso = ttest2(mean_mean_r1_r2_below_identity_line_iso, mean_mean_r1_r2_above_identity_line_iso);
% 
% sign_diff_abs_differnece_r1_r2_below_above_identity_line_iso = ttest2(abs_difference_r1_r2_below_identity_line_iso, abs_difference_r1_r2_above_identity_line_iso);
% 
