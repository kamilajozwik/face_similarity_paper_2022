...
# to render face images (nb. not necessary to recreate data analysis)
Run script `face_similarity_paper_2022/code/render_face_images/render_face_pairs.m` with preferred image size.
